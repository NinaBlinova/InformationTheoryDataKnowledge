...
# Дополняем коды до длины 4 символа
for symbol in codes:
    if len(codes[symbol]) < 4:
        codes[symbol] = codes[symbol].ljust(4, '0')  # Дополняем нулями справа до 4 символов
